...
<br/>
<img src="https://github.com/ballware/ballware-client/blob/main/packages/identity-interface/assets/landscape.png">

## Documentation
For API documentation see Github repository at [TypeDoc](packages/identity-interface/docs/modules.md)
