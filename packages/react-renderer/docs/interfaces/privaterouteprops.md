...
Defined in: [packages/react-renderer/src/renderfactorycontext.ts:71](https://github.com/ballware/ballware-client/blob/d8b5d6b/packages/react-renderer/src/renderfactorycontext.ts#L71)
