...
<br/>
<img src="https://github.com/ballware/ballware-client/blob/main/packages/meta-interface/assets/landscape.png">

## Documentation
For API documentation see Github repository at [TypeDoc](packages/meta-interface/docs/modules.md)
